...
var schedule_router = express.Router();
...
schedule_router.get('/', async function(req, res) {
    ...
    template_page_params['sub_service'] = "Schedule";
    template_page_params['nav_page_info'] = JSON.parse(fs.readFileSync(html_asolute_path+"/website_map.json", "utf8"));
    res.render(html_asolute_path + '/schedule/schedule', template_page_params);
});
