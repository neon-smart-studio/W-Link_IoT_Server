...
var bluetooth_router = express.Router();
...
bluetooth_router.get('/', async function(req, res) {
    ...
    template_page_params['network_type'] = "Bluetooth";
    template_page_params['support_zigbee'] = config.get('support_Zigbee');
    template_page_params['support_ble'] = config.get('support_BLE');
...
module.exports = bluetooth_router;
