...
var water_tank_router = express.Router();
...
water_tank_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Water Tank";
...
module.exports = water_tank_router;
