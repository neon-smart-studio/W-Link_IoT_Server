...
var water_level_sensor_router = express.Router();
...
water_level_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Water Level Sensor";
...
module.exports = water_level_sensor_router;
