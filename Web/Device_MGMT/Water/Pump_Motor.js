...
var pump_motor_router = express.Router();
...
pump_motor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Pump Motor";
...
module.exports = pump_motor_router;
