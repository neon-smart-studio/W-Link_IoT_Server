...
var flow_meter_router = express.Router();
...
flow_meter_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Flow Meter";
...
module.exports = flow_meter_router;
