...
var water_ec_sensor_router = express.Router();
...
water_ec_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Water EC Sensor";
...
module.exports = water_ec_sensor_router;
