...
var em_valve_router = express.Router();
...
em_valve_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Electromagnetic Valve";
...
module.exports = em_valve_router;
