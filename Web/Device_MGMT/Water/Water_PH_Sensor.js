...
var water_ph_sensor_router = express.Router();
...
water_ph_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Water PH Sensor";
...
module.exports = water_ph_sensor_router;
