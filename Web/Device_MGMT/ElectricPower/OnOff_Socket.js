...
var on_off_socket_router = express.Router();
...
on_off_socket_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "OnOff Socket";
...
module.exports = on_off_socket_router;
