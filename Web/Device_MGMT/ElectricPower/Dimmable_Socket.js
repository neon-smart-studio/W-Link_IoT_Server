...
var dimmable_socket_router = express.Router();
...
dimmable_socket_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Dimmable Socket";
...
module.exports = dimmable_socket_router;
