...
var power_meter_router = express.Router();
...
power_meter_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Power Meter";
...
module.exports = power_meter_router;
