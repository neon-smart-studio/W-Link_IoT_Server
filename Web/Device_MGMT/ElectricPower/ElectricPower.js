...
var electric_power_router = express.Router();
...
electric_power_router.use('/OnOff_Socket', require('./OnOff_Socket.js'));
electric_power_router.use('/Dimmable_Socket', require('./Dimmable_Socket.js'));
electric_power_router.use('/Power_Meter', require('./Power_Meter.js'));

electric_power_router.get('/', async function(req, res) {
    var template_page_params = {};

    template_page_params['session_token'] = req.session.id;
    template_page_params['language'] = "Chinese";
    template_page_params['topic'] = "ElectricPower";
...
module.exports = electric_power_router;
