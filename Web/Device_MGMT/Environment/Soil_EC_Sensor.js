...
var soil_ec_sensor_router = express.Router();
...
soil_ec_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Soil EC Sensor";
...
module.exports = soil_ec_sensor_router;
