...
var soil_moisture_sensor_router = express.Router();
...
soil_moisture_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Soil Moisture Sensor";
...
module.exports = soil_moisture_sensor_router;
