...
var pm2_5_sensor_router = express.Router();
...
pm2_5_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "PM2.5 Sensor";
...
module.exports = pm2_5_sensor_router;
