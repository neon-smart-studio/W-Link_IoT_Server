...
var rain_guage_router = express.Router();
...
rain_guage_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Rain Guage";
...
module.exports = rain_guage_router;
