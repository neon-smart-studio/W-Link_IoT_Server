...
var soil_temperature_sensor_router = express.Router();
...
soil_temperature_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Soil Temperature Sensor";
...
module.exports = soil_temperature_sensor_router;
