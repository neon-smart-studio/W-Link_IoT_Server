...
var blind_curtain_router = express.Router();
...
blind_curtain_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Blind Curtain";
...
module.exports = blind_curtain_router;
