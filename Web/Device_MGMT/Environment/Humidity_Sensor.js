...
var humidity_sensor_router = express.Router();
...
humidity_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Humidity Sensor";
...
module.exports = humidity_sensor_router;
