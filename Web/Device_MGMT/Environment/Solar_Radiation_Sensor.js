...
var solar_radiation_sensor_router = express.Router();
...
solar_radiation_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Solar Radiation Sensor";
...
module.exports = solar_radiation_sensor_router;
