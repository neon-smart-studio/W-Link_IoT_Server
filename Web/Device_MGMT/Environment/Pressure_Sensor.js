...
var pressure_sensor_router = express.Router();
...
pressure_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Pressure Sensor";
...
module.exports = pressure_sensor_router;
