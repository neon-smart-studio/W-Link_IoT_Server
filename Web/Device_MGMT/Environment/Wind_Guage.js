...
var wind_guage_router = express.Router();
...
wind_guage_router.get('/', async function(req, res) {
    ...
    template_page_params['username'] = result.username;
    template_page_params['topic'] = "Environment";
    template_page_params['device_type'] = "Wind Guage";
...
module.exports = wind_guage_router;
