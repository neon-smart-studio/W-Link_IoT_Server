...
var door_window_sensor_router = express.Router();
...
door_window_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Door/Window Sensor";
...
module.exports = door_window_sensor_router;
