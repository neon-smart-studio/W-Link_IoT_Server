...
var motion_sensor_router = express.Router();
...
motion_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Motion Sensor";
...
module.exports = motion_sensor_router;
