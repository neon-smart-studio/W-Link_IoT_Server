...
var toggle_switch_router = express.Router();
...
toggle_switch_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Toggle Switch";
...
module.exports = toggle_switch_router;
