...
var on_off_switch_router = express.Router();
...
on_off_switch_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "OnOff Switch";
...
module.exports = on_off_switch_router;
