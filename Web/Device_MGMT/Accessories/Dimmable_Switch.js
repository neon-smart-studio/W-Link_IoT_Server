...
var dimmable_switch_router = express.Router();
...
dimmable_switch_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Dimmable Switch";
...
module.exports = dimmable_switch_router;
