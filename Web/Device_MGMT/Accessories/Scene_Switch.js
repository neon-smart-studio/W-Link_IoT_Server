...
var scene_switch_router = express.Router();
...
scene_switch_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Scene Switch";
...
module.exports = scene_switch_router;
