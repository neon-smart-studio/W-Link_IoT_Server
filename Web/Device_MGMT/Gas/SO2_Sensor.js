...
var so2_sensor_router = express.Router();
...
so2_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "SO2 Sensor";
...
module.exports = so2_sensor_router;
