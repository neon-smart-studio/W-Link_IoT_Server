...
var tvoc_sensor_router = express.Router();
...
tvoc_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "TVOC Sensor";
...
module.exports = tvoc_sensor_router;
