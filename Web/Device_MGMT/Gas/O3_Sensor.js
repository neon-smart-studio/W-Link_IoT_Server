...
var o3_sensor_router = express.Router();
...
o3_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "O3 Sensor";
...
module.exports = o3_sensor_router;
