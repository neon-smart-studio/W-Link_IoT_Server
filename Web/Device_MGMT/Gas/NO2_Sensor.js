...
var no2_sensor_router = express.Router();
...
no2_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "NO2 Sensor";
...
module.exports = no2_sensor_router;
