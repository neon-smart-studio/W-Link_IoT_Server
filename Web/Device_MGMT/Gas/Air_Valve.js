...
var air_valve_router = express.Router();
...
air_valve_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Air Valve";
...
module.exports = air_valve_router;
