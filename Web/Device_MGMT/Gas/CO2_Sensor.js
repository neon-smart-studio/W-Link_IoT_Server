...
var co2_sensor_router = express.Router();
...
co2_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "CO2 Sensor";
...
module.exports = co2_sensor_router;
