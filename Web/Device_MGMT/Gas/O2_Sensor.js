...
var o2_sensor_router = express.Router();
...
o2_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "O2 Sensor";
...
module.exports = o2_sensor_router;
