...
var color_temperature_light_router = express.Router();
...
color_temperature_light_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Color Temperature Light";
...
module.exports = color_temperature_light_router;
