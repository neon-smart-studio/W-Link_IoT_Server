...
var light_sensor_router = express.Router();
...
light_sensor_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Light Sensor";
...
module.exports = light_sensor_router;
