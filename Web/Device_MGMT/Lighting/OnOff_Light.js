...
var onoff_light_router = express.Router();
...
onoff_light_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "OnOff Light";
...
module.exports = onoff_light_router;
