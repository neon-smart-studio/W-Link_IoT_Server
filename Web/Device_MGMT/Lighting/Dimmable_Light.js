...
var dimmable_light_router = express.Router();
...
dimmable_light_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Dimmable Light";
...
module.exports = dimmable_light_router;
