...
var colored_light_router = express.Router();
...
colored_light_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Colored Light";
...
module.exports = colored_light_router;
