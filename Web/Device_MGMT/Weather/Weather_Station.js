...
var weather_station_router = express.Router();
...
weather_station_router.get('/', async function(req, res) {
    ...
    template_page_params['topic'] = "Weather";
    template_page_params['device_type'] = "Weather Station";
...
module.exports = weather_station_router;
