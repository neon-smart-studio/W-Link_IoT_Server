...
var atmosphere_box_router = express.Router();
...
atmosphere_box_router.get('/', async function(req, res) {
    ...
    template_page_params['device_type'] = "Atmosphere Box";
...
module.exports = atmosphere_box_router;
