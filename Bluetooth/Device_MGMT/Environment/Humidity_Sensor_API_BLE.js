...
var Lighting_API_BLE = function () {
    ...
    self.BLE_Light_On_Off_Tog = async function (address_ID, on_off_tog) {
        try {
            if(on_off_tog== "Turn On")
            {
            ...
            else if(on_off_tog== "Toggle")
            {
            }
        }
        catch (e) {
            debug("[Lighting_API_BLE] BLE_Light_On_Off_Tog() Error " + e);
        }
    };
