...
var Yeelight_Lighting_API = function () {
    ...
    self.Yeelight_Light_Identify_Normal = async function (address_ID, duration) {
        try {
            ...
            var times = duration/500;

            var onoff = false;
            session.setPower(false);

            var identify_interval_timer = setInterval(() =>{
                times--;
                ...
                session.setPower(onoff);

                if(times<=0)
                {
                    clearInterval(identify_interval_timer);
                }
            }, 500);
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Identify_Normal() Error " + e);
        }
    };

    self.Yeelight_Light_Identify_With_Effect = async function (address_ID, effect) {
        try {
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Identify_With_Effect() Error " + e);
        }
    };

    self.Yeelight_Light_Turn_On_Off = async function (address_ID, on_off) {
        try {
            var session = yeelight_device_api.Get_Yeelight_Device_Session(address_ID);
            if(session==null)
            {
                return false;
            }
            ...
            session.setPower(on_off);
            
            return true;
        }
        catch (e) {
            debug("[Lighting_API_Yeelight] Yeelight_Light_Turn_On_Off() Error " + e);
        }
    };
    ...
    self.Yeelight_Light_Toggle_OnOff = async function (address_ID) {
        try {
            ...
            //var modes = await twinkly_light_api.Yeelight_Light_Set_Mode(address_ID, mode);
        }
        catch (e) {
            debug("[Lighting_API_Yeelight] Yeelight_Light_Toggle_OnOff() Error " + e);
        }
    };

    self.Yeelight_Light_Turn_On_With_Timed_Off = async function (address_ID, keep_on_time) {
        try {
        }
        catch (e) {
            debug("[Lighting_API_Yeelight] Yeelight_Light_Turn_On_With_Timed_Off() Error " + e);
        }
    };
    ...
    self.Yeelight_Light_Stop_Level_Command = async function (address_ID) {
        try {
            return false;
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Stop_Level_Command() Error " + e);
        }
    };

    self.Yeelight_Light_Move_To_Hue = async function (address_ID, hue, trans_time) {
        try {
            return await this.Yeelight_Light_Move_To_Enhanced_Hue(address_ID, hue, trans_time);
        }
        catch (e) {
    ...
    self.Yeelight_Light_Move_To_Enhanced_Hue = async function (address_ID, hue, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_To_Enhanced_Hue() Error " + e);
        }
    };
    ...
    self.Yeelight_Light_Move_To_Hue_And_Saturation = async function (address_ID, hue, saturation, trans_time) {
        try {
            return await this.Yeelight_Light_Move_To_Enhanced_Hue_And_Saturation(address_ID, hue, saturation, trans_time);
        }
        catch (e) {
    ...
    self.Yeelight_Light_Move_To_Enhanced_Hue_And_Saturation = async function (address_ID, hue, saturation, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_To_Enhanced_Hue_And_Saturation() Error " + e);
        }
    };

    self.Yeelight_Light_Move_To_Color_XY = async function (address_ID, x, y, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_To_Color_XY() Error " + e);
        }
    };

    self.Yeelight_Light_Move_Hue_Up_Down = async function (address_ID, move_rate, direction) {
        try {
            return await this.Yeelight_Light_Move_Enhanced_Hue_Up_Down(address_ID, move_rate, direction);
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_Hue_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Move_Enhanced_Hue_Up_Down = async function (address_ID, move_rate, direction) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_Enhanced_Hue_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Move_Saturation_Up_Down = async function (address_ID, move_rate, direction) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_Saturation_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Move_Color_XY_Up_Down = async function (address_ID, move_rate_x, move_rate_y, direction) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_Color_XY_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Step_Hue_Up_Down = async function (address_ID, step_hue, direction, trans_time) {
        try {
            return await this.Yeelight_Light_Step_Enhanced_Hue_Up_Down(address_ID, step_hue, direction, trans_time);
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Step_Hue_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Step_Enhanced_Hue_Up_Down = async function (address_ID, step_enhanced_hue, direction, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Step_Enhanced_Hue_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Step_Saturation_Up_Down = async function (address_ID, step_saturation, direction, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Step_Saturation_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Step_Color_XY_Up_Down = async function (address_ID, step_x, step_y, direction, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Step_Color_XY_Up_Down() Error " + e);
        }
    };

    self.Yeelight_Light_Stop_Hue_Command = async function (address_ID) {
        try {
            return false;
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Stop_Hue_Command() Error " + e);
        }
    };

    self.Yeelight_Light_Stop_Enhanced_Hue_Command = async function (address_ID) {
        try {
            return false;
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Stop_Enhanced_Hue_Command() Error " + e);
        }
    };

    self.Yeelight_Light_Stop_Saturation_Command = async function (address_ID) {
        try {
            return false;
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Stop_Saturation_Command() Error " + e);
        }
    };
    ...
    self.Yeelight_Light_Move_To_Color_Temperature = async function (address_ID, color_temp, trans_time) {
        try {
            ...
            return await this.Yeelight_Light_Move_To_Mired_Color_Temperature(address_ID, cct_mired, trans_time);
        }
        catch (e) {
    ...
    self.Yeelight_Light_Move_To_Mired_Color_Temperature = async function (address_ID, mired_color_temp, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
            ...
            debug("[Yeelight_Lighting_API] Yeelight_Light_Move_To_Mired_Color_Temperature() Error " + e);
        }
    };

    self.Yeelight_Light_Step_Color_Temperature_Up_Down = async function (address_ID, step_color_temp, direction, trans_time) {
        try {
            ...
            return await this.Yeelight_Light_Step_Mired_Color_Temperature_Up_Down(address_ID, cct_mired, direction, trans_time);
        }
        catch (e) {
            debug("[Yeelight_Lighting_API] Yeelight_Light_Step_Saturation_Up_Down() Error " + e);
        }
    ...
    self.Yeelight_Light_Step_Mired_Color_Temperature_Up_Down = async function (address_ID, step_mired_color_temp, direction, trans_time) {
        try {
            var session = await Get_Light_Address_Info_And_Bridge_Session(username, address_ID);
            if(session==null)
            {
